    ...
    <Link to={url}>
      <article
        className={classNames(
          'h-80 max-w-md px-6 pb-6 flex flex-col justify-end rounded-2xl shadow-1 border border-neutral-4 bg-center bg-no-repeat bg-cover',
          className,
        )}
        style={{
        ...
        <div className="flex flex-col justify-between">
          <div className="flex flex-col">
            <div className="flex items-center">
              <FolderSvg className="text-neutral-1 h-8 w-8" />
              <span className="text-neutral-1 font-semibold line-clamp-1 ml-2">{title}</span>
            </div>
            <span className="line-clamp-2 text-neutral-3 text-sm font-normal mt-1">{description}</span>
          </div>
